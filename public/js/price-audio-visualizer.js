function initPriceAudioVisualizer() {
  const musicBlocks = document.querySelectorAll(".price__top-audio");
  ...
  musicBlocks.forEach((block) => {
    const audioButton = block.querySelector(".price__top-button");
    ...
    const buttonIcons = audioButton.querySelectorAll(".price__top-button-icon");
...
document.addEventListener("DOMContentLoaded", initPriceAudioVisualizer);
